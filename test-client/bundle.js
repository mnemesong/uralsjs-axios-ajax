...
var ajax = __importStar(require("../src/browser"));
var formIds = ["GetForm", "PostForm", "MultipartForm"];
var getAjaxConfigByFormId = function (fid) {
    if (fid === "GetForm") {
        return {
            url: "/get",
...
formIds.forEach(function (fid) {
    ...
    var sendFormBtn = document.getElementById("send" + fid + "Btn");
    sendFormBtn.onclick = function () { return ajax.sendFormAjaxSync(document.getElementById(fid), {}, function (res) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log(res.data);
            return [2 /*return*/];
        });
    }); }); };
    var sendDataBtn = document.getElementById("send" + fid + "DataBtn");
    sendDataBtn.onclick = function () { return ajax.sendAjaxSync(getAjaxConfigByFormId(fid), function (res) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log(res.data);
            return [2 /*return*/];
        });
...
},{"../src/browser":3}],2:[function(require,module,exports){
"use strict";
...
},{"./abstracts":2,"axios/dist/browser/axios.cjs":4}],4:[function(require,module,exports){
